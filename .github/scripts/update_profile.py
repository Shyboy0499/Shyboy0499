...
def fetch_github_stats(username="Shyboy0499"):
...
def update_readme(selected_image, colors):
    ...
    for color in colors:
        ...
        color_imgs.append(f'<img alt="{color}" src="https://raw.githubusercontent.com/Shyboy0499/Shyboy0499/main/img/{hex_clean}.png" width="25" height="20" />')
